...
internal class KspType private constructor(
    ...
    override fun asTypeElement(): XTypeElement {
        val type = ksType ?: error("cannot get type element w/ unresolved type $this")
        check(type.declaration is KSClassDeclaration) {
            "${type.declaration} is not a class declaration"
        }
        return env.wrapClassDeclaration(type.declaration as KSClassDeclaration)
    }
